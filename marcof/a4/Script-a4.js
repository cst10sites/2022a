...
function myColor() 
{
		randomNum = Math.floor(Math.random(randomNum)*4);
	   
	   if(randomNum == 0)
	   {
		Num = "Yellow";
		document.getElementById("myColor").innerHTML = "YELLOW";
		document.getElementById("myColor").style.color = "#ffcc00";
	   }
	   ...
	   {       
			...
			document.getElementById("myColor").style.color = "#cc0000";
        }
        else if (randomNum == 2) 
		{ 
			...
			document.getElementById("myColor").style.color = "#00cc00";
		}
		...
		else if (randomNum == 3)
		{
			...
			document.getElementById("myColor").style.color = "#009999";
		}
		else if (randomNum == 4)
		{
